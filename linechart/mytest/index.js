...
// let myData = "c	d	h	l	o	v\n\
// 10.0	1999-01-04	82.19	45.5	34.4	25.5\n\
// 10.0	2000-01-04	50.34	45.5	34.4	25.5\n\
// 10.0	2001-01-04	120.34	45.5	34.4	25.5\n\
// ";
...
//$.get('http://192.168.1.116:5020/dailyprices/A', function (resp) {
    ...
    let x = d3.scaleTime()
        ...
        .domain(d3.extent(data, function(d, i) {  return parseTime(d.d) ; })); //d3.max(parseTime(d["A dailyprices"][i].d), parseTime(d["B dailyprices"][i].d))
  ...
  /////////////////////////////////////////////////////////////////////////
    // append a g for all mouse over stuff
    let mouseG = chart.append('g')
        .attr('class', 'mouse-over-effects');

    mouseG.append('path') // vertical line
    ...
    mouseG.append('svg:rect')
        ...
        .on('mousemove', function() {
          ...
          // position circle and text
          d3.selectAll('.mouse-per-line')
            .attr('transform', function(d, i) {
              let xDate = x.invert(mouse[0]);
              let bisect = d3.bisector(function(d) { return parseTime(d.d);}).right;
              let idx = bisect(d.h, xDate);
